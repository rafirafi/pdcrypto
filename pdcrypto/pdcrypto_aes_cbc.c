...
static void pdcmode_aes_cbc_init(const struct ccmode_cbc *cbc,
                                 cccbc_ctx *ctx,
                                 size_t key_len,
                                 const void *key)
{
...
static void pdcmode_aes_cbc_encrypt(const cccbc_ctx *ctx,
                                    cccbc_iv *iv,
...
static void pdcmode_aes_cbc_decrypt(const cccbc_ctx *ctx,
                                    cccbc_iv *iv,
                                    unsigned long nblocks,
                                    const void *in,
                                    void *out)
